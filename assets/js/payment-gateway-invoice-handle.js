    ...
    var gateway_button = $('input[name="cardknox_use_gateway"]');
    var cardknox_selected_gateway = $('input[name="cardknox_use_gateway"]').data('gateway_name');
    
    var gatewayTypes = {
        'cardknox': 'Cardknox'
    };
    cardknox_selected_gateway = gatewayTypes[cardknox_selected_gateway];
    console.log(gateway_button)
        ...
        if(checked)
        {
            ...
            $methods_list
                ...
                $('<option></option>',{
                    ...
                    .val('gateway')
                    .html(cardknox_selected_gateway)
            );
    ...
    $('.paid-by-customers').on('change', function(){
		...
		console.log(isGatewayAvailable);
        ...
        if(isGatewayAvailable == 'true'){
            ...
            if($checked){
                $('select[name = "payment_type_id"]')
                        .append('<option id="gateway_option" value="gateway">'+cardknox_selected_gateway+'</option>')
            }
        }
        else
        {
...
// ========================================
	$(document).ready(function () {
       $('.payment_row').addClass('text-capitalize')		
	})
